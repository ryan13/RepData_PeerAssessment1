...
read_data <- function(fname) {
    ...
    tmp <- read.csv(tmp, header=T, colClasses=c("numeric", "character", "numeric"))
...
fill_category_of_data <- function(filling_data) {
  ...
  weekend_steps_per_interval <- aggregate(steps ~ interval, data=weekend, FUN=sum)
  ...
  weekday_steps_per_interval <- aggregate(steps ~ interval, data=weekday, FUN=sum)
